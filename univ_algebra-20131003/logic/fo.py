...
class FOclass():
    ...
    def __init__(self, abbr, name, axioms, results=[], options=[], syntax='Prover9'):
        ...
        FOclass.FOclasses.append(abbr)
        FOclass.FOclasses.sort(key=str.lower)
        FOclass.FirstOrderClasses.append(name + " (" + abbr + ")")
        FOclass.FirstOrderClasses.sort(key=str.lower)
